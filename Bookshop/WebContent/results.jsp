...
%>
<div class="heading">Books in <%=listitems.get(0).getCategory()   %></div>
...
<% offset=offset+30; %>
<a href="ResultsServlet?category=<%=listitems.get(0).getCategory()%>&offset=0">First page</a>
<a href="ResultsServlet?category=<%=listitems.get(0).getCategory()%>&offset=<%=offset%>">next page</a>
<a href="ResultsServlet?category=<%=listitems.get(0).getCategory()%>&offset=<%=offset%>">Last page</a>
<footer>Heu Footer
	</footer>
</body>
</html>